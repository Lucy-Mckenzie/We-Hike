const greatWalks = [
  {
    ...
    Whether you’re a seasoned hiker or a weekend adventurer, the Abel Tasman offers a perfect blend of scenic beauty and challenge.
    The track stretches approximately 60 kilometers and can be tackled in multiple ways – through full hikes, day trips, or even kayaking along the coastline.
    ...
    A must-do for anyone visiting New Zealand! 🌲✨`,
    distance: 60,
  ...
  },
  {
    ...
    With well-maintained trails and various accommodation options, including huts and campsites, the Tongariro Northern Circuit offers a unique and memorable adventure. It’s a must-do trek for those who seek to experience New Zealand’s volcanic landscapes, challenging their limits, and connecting with nature on an unforgettable level.`,
    distance: 43,
  ...
  },
  {
    ...
    The track typically takes 2-4 days to complete and offers well-maintained trails and DOC huts along the way. While challenging in some sections, it’s accessible to those with a good fitness level and a love of scenic adventures.
    What sets the Routeburn apart is its diverse landscapes and the chance to witness nature at its raw, unspoiled best. Whether you’re after a multi-day trek or simply seeking stunning photo opportunities, this track promises awe-inspiring landscapes and a deep connection with New Zealand’s unique wilderness. 🌄✨`,
    distance: 32,
  ...
  },
  {
    ...
    Spanning approximately 4-6 days, the Heaphy Track takes hikers through a variety of terrains, including dense native forests, river crossings, sand dunes, and rugged coastlines. Along the way, you’ll encounter breathtaking landscapes, vibrant wildlife, and tranquil river views.
    ...
    Not only will you witness incredible natural scenery, but you’ll also experience New Zealand’s unique biodiversity, with opportunities to see rare native birds and lush vegetation. A true paradise for nature lovers, the Heaphy Track offers stunning landscapes and a chance to immerse yourself in the wilderness. 🌲✨`,
    distance: 78,
  ...
  },
  {
    ...
    Whether you’re seeking a multi-day adventure or an immersive connection with New Zealand's wilderness, the Kepler Track promises stunning natural beauty, unforgettable encounters with native wildlife, and a chance to push your limits while soaking in the tranquility of Fiordland’s majestic landscapes. `,
    distance: 60,
  ...
  },
  {
    ...
    What makes the Rakiura Track special is its authentic wilderness experience, with well-maintained DOC huts and campgrounds along the way. It’s suitable for hikers of various skill levels, providing an excellent opportunity to explore New Zealand’s natural beauty while enjoying a quiet, peaceful environment away from the crowds.
    Whether you’re a nature lover, wildlife enthusiast, or just seeking a tranquil getaway, the Rakiura Track offers breathtaking landscapes, memorable wildlife encounters, and a chance to truly connect with nature. A must-do adventure for anyone seeking an off-the-beaten-path experience in New Zealand! 🌿🏕️`,
    distance: 32,
  ...
  },
  {
    ...
    Whether you’re admiring the geological wonders of Pancake Rocks, marveling at the lush coastal landscapes, or navigating through dense forests, the Paparoa Track delivers unforgettable scenery, incredible landscapes, and a chance to immerse yourself in the wilderness. A must-do for any adventurer looking to explore New Zealand’s diverse and stunning natural beauty! 🌲🏞️`,
    distance: 55,
  ...
  },
  {
    ...
    The Hump Ridge Track is perfect for those seeking breathtaking scenery, solitude, and an unforgettable backcountry adventure, showcasing the untamed beauty of New Zealand’s landscapes. 🌲🏔️`,
    distance: 61,
  ...
  },
  {
    ...
    The Lake Waikaremoana Track is ideal for nature lovers and those seeking a deeper connection with New Zealand's stunning landscapes, history, and biodiversity, making it a must-do adventure. 🌳✨`,
    distance: 46,
  ...
  },
  {
    ...
    The Whanganui Journey is not just about kayaking—it's about connecting with Maori history, cultural significance, and the serene landscapes that make New Zealand so special. This unforgettable adventure offers an incredible way to experience New Zealand's natural beauty, history, and camaraderie with fellow travelers. 🌊🌿✨`,
    distance: 145,
  ...
  },
  {
    ...
    Dogs are not allowed on the Tongariro Alpine Crossing to protect the natural environment and native wildlife. Whether you’re a passionate hiker or a first-time adventurer, the crossing offers a chance to experience New Zealand’s volcanic landscape, test your endurance, and create memories that will last a lifetime. 🥾✨🏕️`,
    distance: 19.4,
