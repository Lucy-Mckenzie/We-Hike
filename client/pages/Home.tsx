...
export default function Home() {
  return (
    ...
    <div className='lg:px-5 lg:py-10 py-5 text-center w-full lg:max-w-4xl'>
      <h1 className='font-lato lg:mb-5 mb-2 lg:text-left text-center text-xl sm:text-2xl lg:text-4xl pr-8'>
